  ...
  return (
    <main className="bg-transparent text-[#fff4ee]">
      <section className="mx-auto w-full max-w-7xl px-6 pb-20 pt-24 md:px-10 md:pb-24 md:pt-28 xl:px-12">
        ...
        <p className="mt-7 max-w-3xl text-base leading-relaxed text-[#f5dfd3]/82">
      ...
      <section className="mx-auto grid w-full max-w-7xl gap-7 px-6 pb-28 md:grid-cols-2 md:px-10 md:pb-32 xl:grid-cols-3 xl:px-12">
        {servicios.map((servicio, index) => (
          <article
            key={servicio}
            className="group rounded-3xl border border-[#f2d4c7]/14 bg-[linear-gradient(170deg,rgba(63,37,31,0.58)_0%,rgba(25,15,13,0.9)_100%)] p-7 shadow-[0_18px_50px_-34px_rgba(0,0,0,0.48)] transition hover:-translate-y-0.5 hover:border-[#f6e0d3]/30"
          >
            <p className="text-xs font-semibold uppercase tracking-[0.2em] text-[#efd6ca]/62">
              Servicio {String(index + 1).padStart(2, "0")}
            </p>
            <h2 className="mt-4 text-xl leading-snug text-[#fff1e8]">{servicio}</h2>
            <p className="mt-5 text-sm leading-relaxed text-[#f5dfd4]/78">
      ...
      <section className="border-t border-[#f2d3c5]/15 bg-transparent">
        <div className="mx-auto flex w-full max-w-7xl flex-col items-start justify-between gap-8 px-6 py-16 md:flex-row md:items-center md:px-10 md:py-20 xl:px-12">
          <div>
            <p className="text-xs font-semibold uppercase tracking-[0.22em] text-[#f0d8cb]/70">
              Siguiente paso
            </p>
            <h3 className="mt-4 text-3xl leading-tight text-[#fff1e9]">
          ...
          <div className="flex flex-wrap gap-3">
            ...
            <a
              ...
              target="_blank"
              rel="noreferrer"
              className="rounded-full border border-[#f2d4c7]/28 bg-[#f8dbc8]/10 px-7 py-3 text-sm font-medium text-[#ffece2] transition hover:border-[#f6dfd2]/40"
            >
              WhatsApp
            </a>
          </div>
